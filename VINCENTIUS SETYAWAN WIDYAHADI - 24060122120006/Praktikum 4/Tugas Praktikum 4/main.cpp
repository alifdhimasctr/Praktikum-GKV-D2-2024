...
NIM			: 24060122120006
Tanggal		: 25/03/2024
Deskripsi	: Template untuk mainan objek 3D berbentuk balok. Kamera bisa maju mundur kiri kanan. Sudah dilengkapi pencahayaan. Sekarang pake texture.
*/
...
void PiramidaSegitiga()
{
    ...
    // Sisi depan
    glVertex3f(0.0f, 3.0f, 0.0f);     // Puncak
    glVertex3f(-3.0f, -3.0f, 3.0f);   // Titik kiri bawah
    glVertex3f(3.0f, -3.0f, 3.0f);    // Titik kanan bawah
