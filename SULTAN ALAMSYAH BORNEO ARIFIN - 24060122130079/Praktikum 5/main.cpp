...
Deskripsi: Program utama untuk imageloader, membuat enam sisi kubus diisi oleh 6 gambar berbeda
*/
#include <iostream> 
#include <stdlib.h> 
...
void initRendering() {
    ...
    Image* image = loadBMP("bg.bmp"); //Gambar 1
    Image* image1 = loadBMP("Wallpaper.bmp"); //Gambar 2
    Image* image2 = loadBMP("Nature.bmp"); //Gambar 3
    Image* image3 = loadBMP("Winters.bmp"); //Gambar 4
    Image* image4 = loadBMP("MV2A.bmp"); //Gambar 5
    Image* image5 = loadBMP("MV2B.bmp"); //Gambar 6
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Texture With 6 Different Image");
    initRendering();
