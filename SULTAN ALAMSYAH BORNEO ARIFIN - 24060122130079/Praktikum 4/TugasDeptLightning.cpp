...
Deskripsi: Program utama simulasi DeptLightning
*/
...
void PrismaSegitigaKayu()
{
    ...
    glVertex3f(3.0f, -3.0f, 0.0f);
    glVertex3f(0.0f, 3.0f, 0.0f); // Titik atas segitiga
    glEnd();
    glPopMatrix();
    ...
    glRotated(90, 1, 0, 0);
    glTranslatef(0, 0, 3);
    glColor3f(0.0f, 1.0f, 1.0f); //Warna hijau tosca
    glBegin(GL_QUADS);
    ...
    glVertex3f(9.0f, -3.0f, 0.0f); //Kanan bawah
    glVertex3f(9.0f, 3.0f, -3.0f); //Kanan atas
...
void display() {
    ...
    PrismaSegitigaKayu(); //Objek yang dibuat adalah prisma segitiga mendatar
    glutSwapBuffers();
    glFlush();
}
