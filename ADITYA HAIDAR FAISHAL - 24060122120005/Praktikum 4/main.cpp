...
void KotakKayu() {
    ...
    glBegin(GL_QUADS);
    glVertex3f(-3.0f, -3.0f, 3.0f); // Titik A
    glVertex3f(3.0f, -3.0f, 3.0f);  // Titik B
    glVertex3f(3.0f, 3.0f, 3.0f);   // Titik C
    glVertex3f(-3.0f, 3.0f, 3.0f);  // Titik D
    glEnd();
    glPopMatrix();
    ...
    glBegin(GL_QUADS);
    glVertex3f(-3.0f, -3.0f, -6.0f); // Titik E
    glVertex3f(3.0f, -3.0f, -6.0f);  // Titik F
    glVertex3f(3.0f, 3.0f, -6.0f);   // Titik G
    glVertex3f(-3.0f, 3.0f, -6.0f);  // Titik H
    glEnd();
    glPopMatrix();
    ...
    glVertex3f(-3.0f, 3.0f, 3.0f);  // Titik D
    glVertex3f(3.0f, 3.0f, 3.0f);   // Titik C
    glVertex3f(3.0f, 3.0f, -3.0f);  // Titik G
    glVertex3f(-3.0f, 3.0f, -3.0f); // Titik H
    glEnd();
    glPopMatrix();

    // Bawah
    glPushMatrix();
    glColor3f(0.0f, 0.0f, 1.0f); // Warna merah
    glBegin(GL_QUADS);
    glVertex3f(-3.0f, -3.0f, 3.0f);  // Titik A
    glVertex3f(3.0f, -3.0f, 3.0f);   // Titik B
    glVertex3f(3.0f, -3.0f, -3.0f);  // Titik F
    glVertex3f(-3.0f, -3.0f, -3.0f); // Titik E
    glEnd();
    glPopMatrix();

    // Kiri
    glPushMatrix();
    glColor3f(1.0f, 1.0f, 0.0f); // Warna merah
    glBegin(GL_QUADS);
    glVertex3f(-3.0f, -3.0f, 3.0f); // Titik A
    glVertex3f(-3.0f, -3.0f, -6.0f); // Titik E
    glVertex3f(-3.0f, 3.0f, -6.0f);  // Titik H
    ...
    // Kanan
    glPushMatrix();
    glColor3f(1.0f, 0.0f, 1.0f); // Warna merah
    glBegin(GL_QUADS);
    glVertex3f(3.0f, -3.0f, 3.0f); // Titik B
    glVertex3f(3.0f, -3.0f, -6.0f); // Titik F
    glVertex3f(3.0f, 3.0f, -6.0f);  // Titik G
