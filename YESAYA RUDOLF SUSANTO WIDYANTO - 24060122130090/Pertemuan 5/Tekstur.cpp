...
void initRendering() {
    ...
    _textureIds[0] = loadTexture("AkemiHomura.bmp");
    _textureIds[1] = loadTexture("Asta.bmp");
    _textureIds[2] = loadTexture("Fern.bmp");
    _textureIds[3] = loadTexture("HoshimachiSuisei.bmp");
    _textureIds[4] = loadTexture("MakiseKurisu.bmp");
    _textureIds[5] = loadTexture("SuzukazeAoba.bmp");
}
