/*
    File        : tugas4.cpp    25/03/24
    Penulis     : Arifin Nurmuhammad Haris
    Deskripsi   : Mengaplikasikan Depth dan Lighting yang ada di modul, dimodifikasi
                  menjadi bentuk lain selain kubus, dan diubah warnanya
*/
...
void display(){
	...
	Grid(); // Gambar grid
	BalokKayu(); // Gambar objek di sini...
	glutSwapBuffers();
	glFlush();
}
