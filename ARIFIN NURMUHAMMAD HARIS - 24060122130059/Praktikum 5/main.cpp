/*
    File        : main.cpp    25/03/24
    Penulis     : Arifin Nurmuhammad Haris
	Deskripsi   : Mengaplikasikan Image loader dalam sebuah kubus yang ada di
				  dalam modul, ubah setiap sisi menjadi gambar yang berbeda beda
*/
