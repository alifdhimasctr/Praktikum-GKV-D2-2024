...
NIM		: 24060122130067
Tugas Praktikum GKV D2 Pertemuan 5*/
...
void initRendering() {
	...
	Image* images[6];
    images[0] = loadBMP("ochobot.bmp");
    images[1] = loadBMP("mechabot.bmp"); 
    images[2] = loadBMP("solar.bmp"); 
    images[3] = loadBMP("halilintar.bmp"); 
    images[4] = loadBMP("taufan.bmp"); 
    images[5] = loadBMP("blaze.bmp"); 
    for (int i = 0; i < 6; ++i) {
...
glutCreateWindow("Texture With Image Boboiboy");
initRendering();
