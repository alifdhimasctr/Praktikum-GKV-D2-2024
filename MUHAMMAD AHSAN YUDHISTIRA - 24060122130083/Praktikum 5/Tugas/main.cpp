/*  Nama    	: Muhammad Ahsan Yudhistira
    NIM     	: 24060122130083
    Deskripsi 	: Membuat Kubus dengan ggambar di setiap sisinya
*/
...
void initRendering() {
  ...
  Image* image1 = loadBMP("img1.bmp");
  _textureId1 = loadTexture(image1);
  delete image1;
  
  Image* image2 = loadBMP("img2.bmp");
  _textureId2 = loadTexture(image2);
  delete image2;
  
  Image* image3 = loadBMP("img3.bmp");
  _textureId3 = loadTexture(image3);
  delete image3;
  
  Image* image4 = loadBMP("img4.bmp");
  _textureId4 = loadTexture(image4);
  delete image4;
  
  Image* image5 = loadBMP("img5.bmp");
  _textureId5 = loadTexture(image5);
  delete image5;
  
  Image* image6 = loadBMP("img6.bmp");
  _textureId = loadTexture(image6);
  delete image6;
}
