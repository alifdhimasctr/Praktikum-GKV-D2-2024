...
Image* image = loadBMP("cat1.bmp");
_textureId = loadTexture(image);
Image* image1=loadBMP("cat2.bmp");
_textureId1 = loadTexture(image1);
Image* image2 = loadBMP("cat3.bmp");
_textureId2 = loadTexture(image2);
Image* image3=loadBMP("cat4.bmp");
_textureId3 = loadTexture(image3);
Image* image4 = loadBMP("cat5.bmp");
_textureId4 = loadTexture(image4);
Image* image5=loadBMP("cat6.bmp");
